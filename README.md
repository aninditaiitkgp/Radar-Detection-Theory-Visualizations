...
Plots Gaussian PDFs under H0 (μ=0) and H1 (μ=1), σ=1 with decision threshold γ=1.5. Shades detection/false-alarm regions for radar hypothesis testing visualization.
